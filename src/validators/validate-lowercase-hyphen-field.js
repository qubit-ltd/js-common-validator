...
//
////////////////////////////////////////////////////////////////////////////////
import { LowercaseHyphenRule } from '@qubit-ltd/common-validation-rule';
 ...
 * letters and hyphens (spaces are allowed before and after).
 *
 * @param {string} value
 ...
 * @author Haixing Hu
 */
function validateLowercaseHyphenField(value, context = {}) {
  return validateFieldByRule(value, LowercaseHyphenRule, context);
}

export default validateLowercaseHyphenField;
