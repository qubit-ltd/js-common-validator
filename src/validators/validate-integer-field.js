...
//
////////////////////////////////////////////////////////////////////////////////
import { IntegerRule } from '@qubit-ltd/validation-rule';
...
function validateIntegerField(value, context = {}) {
  context.label ??= '数值';
  context.invalidMessage ??= '{whose}{label}必须是整数';
  return validateFieldByRule(value, IntegerRule, context);
}

export default validateIntegerField;
