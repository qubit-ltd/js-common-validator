...
/**
 * Verify whether a field value of an object represents a valid local time.
 *
 * @param {string} value
 ...
 * @author Haixing Hu
 */
function validateTimeField(value, context = {}) {
  context.label ??= '时间';
  ...
  context.comparator = compareTime;
  return validateFieldByRule(value, LocalTimeRule, context);
}

export default validateTimeField;
