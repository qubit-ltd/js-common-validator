...
//
////////////////////////////////////////////////////////////////////////////////
import { LowercaseUnderscoreRule } from '@qubit-ltd/common-validation-rule';
import validateFieldByRule from './validate-field-by-rule';

/**
 * Verify whether a field value of an object is a string composed of lowercase
 ...
 * @author Haixing Hu
 */
function validateLowercaseUnderscoreField(value, context = {}) {
  return validateFieldByRule(value, LowercaseUnderscoreRule, context);
}

export default validateLowercaseUnderscoreField;
