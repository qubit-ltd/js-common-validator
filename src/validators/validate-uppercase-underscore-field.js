...
//
////////////////////////////////////////////////////////////////////////////////
import { UppercaseUnderscoreRule } from '@qubit-ltd/common-validation-rule';
import validateFieldByRule from './validate-field-by-rule';

/**
 * Verify whether a field value of an object is a string composed of uppercase
 * letters and underscores (spaces are allowed before and after).
 *
 * @param {string} value
 ...
 * @author Haixing Hu
 */
function validateUppercaseUnderscoreField(value, context = {}) {
  return validateFieldByRule(value, UppercaseUnderscoreRule, context);
}

export default validateUppercaseUnderscoreField;
